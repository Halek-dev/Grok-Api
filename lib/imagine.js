...
const PRICES = {
  ...
  // The default. It is the model xAI is keeping: 1.5 Quality retires on
  // 2 November 2026 and is served by this one from then on, and it was 1.5
  // Quality that xAI briefly stopped serving on 18 September. Nobody should
  // land on a model that is being wound down without choosing it.
